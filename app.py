...
def reset_rag_agent(temperature,
                                llm_model,
                                embedding_model,
                                chunk_size,
                                agent_profile,
    ...
    st.session_state.conversational_rag_chain = init_rag_agent_from_profile(temperature=temperature,
                                                                            llm_model=llm_model,
...
def update_fields_with_profile(profile_data):
    ...
    reset_rag_agent(temperature=st.session_state.temperature,
    ...
    if prompt := st.chat_input():
        ...
        if 20>number_of_messages:
            ...
            with st.spinner("Processing..."):
                answer,context, st.session_state.chat_history = process_prompt(prompt,
