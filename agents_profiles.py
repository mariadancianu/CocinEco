...
def create_qa_system_all_in_one_prompt():
    ...
    return (
        ...
        + f"with a height of {st.session_state.height}  cm and a weight of {st.session_state.weight}  kg from the country {st.session_state.country}."
        + "you need to help this person with their diet."
        + "Using the information contained in the context,"
        + "The person you are talking to has the following health conditions: "
        + f"{st.session_state.health_condition_list}"
        + " and "
        + f"{st.session_state.other_health_condition_str}"
        + "They also have the following allergies: "
        + f"{st.session_state.allergies_list}"
        + " and "
        + f"{st.session_state.other_allergies_str}"
        + "They also have the follwing food intolerances: "
        + f"{st.session_state.food_intolerance_list}"
        + " and "
        + f"{st.session_state.other_food_intolerance_str}"
